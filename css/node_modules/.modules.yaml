...
hoistedDependencies:
  ...
  jest-circus@28.1.3:
    jest-circus: private
  jest-cli@28.1.3(@types/node@22.7.5):
    jest-cli: private
  jest-config@28.1.3(@types/node@22.7.5):
    jest-config: private
  jest-diff@28.1.3:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 12 Oct 2024 11:51:36 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: C:\Grader\exerciseCSS\html-exercise-student-portal-2-v1\node_modules\.pnpm
